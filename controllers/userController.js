...
const updatePfofile=async(req,res)=>{
    try {
        const {userId}=req
        ...
        res.json({success:true, messae:"Profile Updated"})
    } catch (error) {
        console.log(error)
...
const bookAppointment =async (req,res)=>{
    try {
        ...
        if(!docData.available){
            return res.json({success:false,message:"Doctor not avaiable"})
        }
...
export {registerUser,loginUser,getProfile,updatePfofile,bookAppointment,listAppointments,cancelAppointment,checkSlotAvailability,paymentRazorpay,verifyRazorpay}